...
import { Calendar, History, Clock, Sparkles } from 'lucide-react';
      ...
      <div className="space-y-3 md:space-y-6">
        ...
        <Tabs defaultValue="entry" className="space-y-4">
          <TabsList className="grid w-full max-w-lg grid-cols-4">
            ...
            <TabsTrigger value="adjustments" className="gap-1 text-xs md:text-sm px-1 md:px-3">
              <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4" />
              <span className="hidden sm:inline">{t('adjustments.tabLabel')}</span>
              <span className="sm:hidden">{t('adjustments.tabLabelShort')}</span>
            </TabsTrigger>
            <TabsTrigger value="overtime" className="gap-1 text-xs md:text-sm px-1 md:px-3">
            ...
            <TabsTrigger value="history" className="gap-1 text-xs md:text-sm px-1 md:px-3">
